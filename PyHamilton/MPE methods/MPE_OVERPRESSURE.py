...
from pyhamilton import (HamiltonInterface,  LayoutManager, Plate96, Tip96, initialize, tip_pick_up, tip_eject,

 aspirate, dispense,  oemerr, resource_list_with_prefix, normal_logging)



from pyhamilton import (mpe2_connect_com,mpe2_stop_vacuum, mpe2_filter_plate_placed, mpe2_initialize, mpe2_clamp_filter_plate, mpe2_process_filter_to_waste_container, mpe2_retrieve_filter_plate, mpe2_filter_plate_removed)
...
def Activate_overpressure(mpe2_filter_plate_placed, mpe2_clamp_filter_plate, mpe2_start_mpe_vacuum, mpe2_process_filter_to_waste_container, mpe2_stop_vacuum, mpe2_filter_plate_removed):
...
if __name__ == '__main__':
    ...
    with HamiltonInterface(simulate=True) as ham_int:
        ...
        Activate_overpressure(mpe2_filter_plate_placed, mpe2_clamp_filter_plate, mpe2_start_mpe_vacuum, mpe2_process_filter_to_waste_container, mpe2_stop_vacuum, mpe2_filter_plate_removed)
